...
import { getMovie, IMG_BASE } from "../api";

export default function MovieDetail({ id: propId, onAddFavorite }) {
        ...
        <div>
            ...
            <div className="flex flex-col gap-6 md:flex-row">
                ...
                <div className="flex-1">
                    ...
                    <p className="text-gray-500 mb-1">Sortie : {movie.release_date || "Inconnue"}</p>
                    <p className="text-gray-500 mb-4">
                        Genres : {movie.genres?.map((g) => g.name).join(", ") || "N/A"}
                    </p>
                    <p className="text-gray-700 mb-4">{movie.overview || "Pas de synopsis disponible."}</p>
