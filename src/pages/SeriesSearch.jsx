...
import { searchTV, addFavoriteSeries } from "../api";
...
export function SeriesSearch() {
    ...
    function handleAddFavorite(serie) {
        addFavoriteSeries(serie)
            .then(() => setFavMessage(`"${serie.name}" ajouté aux favoris !`))
    ...
    return (
        <main className="flex flex-1 flex-col items-center bg-gray-50 p-6">
            <h1 className="text-4xl font-bold mb-6">Recherche de séries</h1>
            ...
            {tvId && (
                ...
                >
                    ...
                    >
                        ...
                        <SeriesDetail id={tvId} onAddFavorite={handleAddFavorite} />
                    </div>
                </div>
            )}
        </main>
